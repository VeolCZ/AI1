...
constraints = [
    Constraint(
        '[potion1,potion2,potion3,potion4,potion5,potion6,potion7].count("wine") == 2'
    ),
    Constraint(
        '[potion1,potion2,potion3,potion4,potion5,potion6,potion7].count("poison") == 3'
    ),
    Constraint(
        '[potion1,potion2,potion3,potion4,potion5,potion6,potion7].count("onwards") == 1'
    ),
    Constraint(
        '[potion1,potion2,potion3,potion4,potion5,potion6,potion7].count("back") == 1'
    ),
]
